...
public class EventRequestDecisionServlet extends BaseServlet {
    private final EventRegistrationRequestDAO requestDAO = new EventRegistrationRequestDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        String info = accept ? "Demande+d'inscription+acceptee." : "Demande+d'inscription+refusee.";

        requestDAO.decide(requestId, responsableId, accept);
